...
const experiences = [
  ...
  },
  {
    ...
    end_date: "Present",
    location: "",
    description: "Cybersecurity aligns naturally with my background in safety-critical, high-risk environments. I bring a disciplined, systems-focused mindset shaped by military service, industrial safety, technical documentation, and continuous self-directed learning.",
    highlights: ["Systems Thinking", "Risk Assessment", "Disciplined Approach", "Continuous Learning", "Safety-first Mindset"]
  }
]
